...
input2 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
...
expected2 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
...
input3 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
                     DTHDTC = c("23MAR2022", "24MAR2022", "25MAR2022"),
                     DCUT_TEMP_REMOVE=c("", "", ""),
                     DCUT_TEMP_DTHCHANGE=c("Y", "", NA),
                     stringsAsFactors = FALSE)

expected3 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
                        DTHDTC = c("", "24MAR2022", "25MAR2022"),
                        stringsAsFactors = FALSE)
...
input4 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
                     DCUT_TEMP_REMOVE=c("", "", ""),
                     DCUT_TEMP_DTHCHANGE=c("Y", "", NA),
                     stringsAsFactors = FALSE)

expected4 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
                        stringsAsFactors = FALSE)
...
input5 <- data.frame(USUBJID = c("UXYZ123a", "UXYZ123b", "UXYZ123c"),
